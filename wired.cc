...
int main()
{
  ...
  uint32_t packets[12] = {40,44,48,52,60,250,300,552,576,628,1420,1500};
  ...
  for(j=0;j<12;j++)
  {
	...
	p2pHelper2.SetQueue("ns3::DropTailQueue");
    ...
    // Flow monitor
    flowMonitor->SerializeToXmlFile("wired.xml", true, true);
